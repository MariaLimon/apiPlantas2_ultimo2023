...
namespace apiPlantas2.Migrations
{
    ...
    [Migration("20231207004055_cambioReprtesagregar")]
    partial class cambioReprtesagregar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiPlantas.Data.Models.Humedad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("HumedadDetectada")
            ...
            modelBuilder.Entity("ApiPlantas.Data.Models.Tamaño", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TamañoDetectada")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ApiPlantas.Data.Models.Temperatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TemperaturaDetectada")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ApiPlantas.Data.Models.Planta_Reporte", b =>
                {
                    b.HasOne("ApiPlantas.Data.Models.Humedad", "humedad")
                    ...
                    b.HasOne("ApiPlantas.Data.Models.Tamaño", "tamaño")
                        .WithMany("Planta_Reporte")
                        .HasForeignKey("TamañoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiPlantas.Data.Models.Temperatura", "temperatura")
                        .WithMany("Planta_Reporte")
                        .HasForeignKey("TemperaturaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("humedad");
            ...
            modelBuilder.Entity("ApiPlantas.Data.Models.Reportes", b =>
                {
                    b.HasOne("ApiPlantas.Data.Models.Plantas", "plantas")
                        .WithMany()
